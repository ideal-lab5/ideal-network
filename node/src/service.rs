...
pub async fn start_parachain_node(
    ...
    let beefy_gossip_proto_name =
        beefy::gossip_protocol_name(&genesis_hash, parachain_config.chain_spec.fork_id());
    ...
    if parachain_config.offchain_worker.enabled {
        ...
        let ocw = sc_offchain::OffchainWorkers::new(sc_offchain::OffchainWorkerOptions {
        ...
        task_manager.spawn_handle().spawn(
            ...
            "offchain-work",
            ocw.run(client.clone(), task_manager.spawn_handle()).boxed(),
        );
    }
    ...
    let keystore = if parachain_config.role.is_authority() {
